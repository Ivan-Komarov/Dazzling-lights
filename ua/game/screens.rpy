...
init python:
    style.main_menu_button_text.font = "gui/font/Tektur-Regular.ttf"
    style.main_menu_button_text.color = "#FFFFFF"  # text color
...
## Екран вибору ################################################################
##
## Цей екран використовується для показу ігрових варіантів вибору,
## представлених оператором «menu». Один параметр, «items», являє собою список
## об’єктів, кожен з яких має підпис і поле дії.
##
    ...
    vbox:
        for i in items:
            textbutton i.caption action i.action:
                text_style "choice_text_local"

style choice_text_local:
    font "gui/font/Tektur-Regular.ttf"
    size 30
    color "#000000"
    hover_color "#450e7d"
...
screen file_slots(title):
    ...
    use game_menu(title):
        ...
        fixed:
            ...
            ## Це гарантує, що введення отримає подію входу раніше, ніж будь-
            ## яка кнопка.
            order_reverse True
